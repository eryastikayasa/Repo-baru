...
void websocket_schedule_setup(uint32_t generation); extern volatile uint8_t gemini_volume_percent; void set_gemini_volume(uint8_t percent); uint8_t get_gemini_volume(void);
